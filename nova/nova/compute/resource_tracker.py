...
class ResourceTracker(object):
    ...
    def _report_hypervisor_resource_view(self, resources):
        ...
        LOG.debug("Hypervisor: All frequencies (Hz): %s" % all_freq)
        LOG.debug("Hypervisor: Current frequency (Hz): %s" % curr_freq)
        LOG.debug("Hypervisor: Maximum frequency (Hz): %s" % max_freq)
